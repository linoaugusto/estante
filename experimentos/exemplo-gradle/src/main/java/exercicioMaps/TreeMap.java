...
public class TreeMap {
    public static void main(String[] args) {
        Map<String, String> estadoDoBrasil = new java.util.TreeMap<>();
        ...
        System.out.println("O HashMap contém Maranhão? A resposta é " + estadoDoBrasil.containsKey("Maranhão"));

        System.out.println(estadoDoBrasil.keySet());

        System.out.println(estadoDoBrasil.get("RN"));
